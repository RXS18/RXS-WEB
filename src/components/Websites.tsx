    ...
    <section id="websites" className="py-24 lg:py-32 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mt-16">
          ...
          <button className="inline-flex items-center space-x-2 text-lg font-medium bg-black text-white px-8 py-4 rounded-full hover:bg-gray-800 transition-all duration-300 transform hover:scale-105">
